...
const InitialState = {
    transactions: savedTransactions ? savedTransactions : [
        { id: 1, NameofExpense: 'Parotta', Category: 'Food', Date:'03-02-2023', Amount : 150, UpdatedAt:"few min ago", CreatedBy : 'Me'  },
        ...
        { id: 4, NameofExpense: 'Camera', Category: 'Passion', Date:'02-02-2023', Amount : 80000, UpdatedAt:"few min ago", CreatedBy : 'Me'  },
        { id: 5, NameofExpense: 'Headphones', Category: 'Entertainment', Date:'27-02-2023', Amount : 3000, UpdatedAt:"few min ago", CreatedBy : 'Jhon'  },
        { id: 6, NameofExpense: 'Tea', Category: 'Snacks', Date:'18-03-2023', Amount : 50, UpdatedAt:"few min ago", CreatedBy : 'Me'  },
